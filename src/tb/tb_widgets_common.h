...
public:
	...
	bool GetText(TBStr &text) override { return m_text.GetText(text); }
...
public:
	...
	PreferredSize OnCalculatePreferredContentSize(const SizeConstraints &constraints) override { return m_layout.GetPreferredSize(); }
